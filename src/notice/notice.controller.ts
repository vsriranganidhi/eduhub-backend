...
export class NoticeController {
  ...
  findAll(
    ...
    return this.noticeService.findAll(search, subject, teacherName);
  }
  ...
  remove(@Param('id') id: string, @Req() req: any) {
    ...
    return this.noticeService.remove(id, req.user.sub, req.user.role);
  }
}